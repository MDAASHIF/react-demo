...
export default function Sidebar(){
        ...
        <div id="app-sidepanel" className="app-sidepanel" > 
	        ...
	        <div className="sidepanel-inner d-flex flex-column">
		        ...
		        <div className="app-branding">
		            <a className="app-logo" href="index.html"><img className="logo-icon me-2" src="assets/images/app-logo.svg" alt="logo" /><span className="logo-text">NIMMI ADMIN</span></a>
  ...
  <circle cx="3.5" cy="10.5" r=".5"/>
	  ...
	  <path d="M6 0h7a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2v-1a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1H4a2 2 0 0 1 2-2z"/>
		                         ...
		                         <span className="nav-link-text">Setting Manage</span>
	  ...
	  <path fillRule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
					        ...
					        <div id="submenu-1" className="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
						        <ul className="submenu-list list-unstyled">
							        <li className="submenu-item"><Link className="submenu-link" to="/brand-add">Brand</Link></li>
							        <li className="submenu-item"><a className="submenu-link" href="account.html">Category</a></li>
							        <li className="submenu-item"><a className="submenu-link" href="settings.html">Sub Category</a></li>
									<li className="submenu-item"><a className="submenu-link" href="settings.html">Color</a></li>
									<li className="submenu-item"><a className="submenu-link" href="settings.html">Size</a></li>
	  ...
	  <path fillRule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
					        ...
					        <div id="submenu-2" className="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
						        <ul className="submenu-list list-unstyled">
							        <li className="submenu-item"><a className="submenu-link" href="login.html">Customer</a></li>
							        <li className="submenu-item"><a className="submenu-link" href="signup.html">Brand Admin</a></li>
  ...
  <path d="M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286zm1.557 5.763c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94z"/>
		                         ...
		                         <span className="nav-link-text">Slider</span>
					        </a>
					    </li>				    
				    </ul>
			    </nav>
